  ...
  const searchProducts = async (product_name) => {
    try {
      const response = await axios({
        method: "post",
        url: `${process.env.REACT_APP_API_URL}search-products`,
        data: {
    ...
    handleConfirmDeleteProduct: function (product) {
      ...
      async function deleteProduct(product_id) {
        try {
          const response = await axios({
            method: "post",
            url: `${process.env.REACT_APP_API_URL}delete-product`,
            data: {
    ...
    handleConfirmDeleteDetailProduct: function (product) {
      ...
      async function deleteDetailProduct(details_product_id) {
        try {
          const response = await axios({
            method: "post",
            url: `${process.env.REACT_APP_API_URL}delete-detail-product`,
            data: {
