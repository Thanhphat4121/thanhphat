...
export default function AdminPage() {
  ...
  const getSalesToday = async (name) => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-today`,
      });
  ...
  const getSalesTomorrow = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-tomorrow`,
      });
  ...
  const getSalesByDate = async (date) => {
    try {
      const response = await axios({
        method: "post",
        url: `${process.env.REACT_APP_API_URL}get-sales-by-date`,
        data: {
  ...
  const getSalesByMonth = async (date) => {
    try {
      const response = await axios({
        method: "post",
        url: `${process.env.REACT_APP_API_URL}get-sales-by-month`,
        data: {
          date: moment(date).format("YYYY-MM-DD"),
        },
      });
  ...
  const getSalesByYear = async (date) => {
    try {
      const response = await axios({
        method: "post",
        url: `${process.env.REACT_APP_API_URL}get-sales-by-year`,
        data: {
          date: moment(date).format("YYYY-MM-DD"),
        },
      });
  ...
  const getSalesMonth = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-month`,
      });
  ...
  const getSalesLastMonth = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-lastmonth`,
      });
  ...
  const getSalesYear = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-year`,
      });
  ...
  const getSalesLastYear = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-lastyear`,
      });
  ...
  const getSalesInWeek = async () => {
    try {
      const response = await axios({
        method: "get",
        url: `${process.env.REACT_APP_API_URL}get-sales-inweek`,
      });
